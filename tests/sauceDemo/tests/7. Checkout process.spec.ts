...
// Define a test case for the checkout process
test('Case 7: Checkout Process: @regression @smoke', async ({ page, isMobile, browser }) => {
    ...
    // the successful completion of the checkout process
